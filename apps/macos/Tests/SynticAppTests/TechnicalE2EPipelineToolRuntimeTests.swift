...
private final class FakeCoreBridge: SynticCoreVersionProviding {
    ...
    func commandClassifyJSON(_ utterance: String) -> String {
        ...
        if normalized.contains("note") || normalized.contains("notiz") {
            return "{\"kind\":\"save_note\",\"summary\":\"Notiz speichern\",\"confidence_percent\":70,\"requires_confirmation\":true}"
        }
        return "{\"kind\":\"unknown\",\"summary\":\"unsupported\",\"confidence_percent\":0,\"requires_confirmation\":false}"
    }
