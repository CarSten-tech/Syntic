    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Tool runtime signals: \(technicalE2EPipeline.toolRuntimeSignalsJSON)")
                ...
                .foregroundStyle(.secondary)
                .lineLimit(4)
            Text("Core session history: \(technicalE2EPipeline.coreSessionHistoryJSON)")
                .font(.caption2)
                .foregroundStyle(.secondary)
                .lineLimit(4)
            Text("Tool runtime queue: \(technicalE2EPipeline.toolRuntimeQueueJSON)")
                .font(.caption2)
                .foregroundStyle(.secondary)
                .lineLimit(4)
            Text("Tool runtime execution log: \(technicalE2EPipeline.toolRuntimeExecutionLogPath)")
                .font(.caption2)
                .foregroundStyle(.secondary)
                .lineLimit(2)
            Text("Telemetry log: \(technicalE2EPipeline.telemetryLogPath)")
                ...
                .foregroundStyle(.secondary)
                .lineLimit(2)
            Text("Core feed projection log: \(technicalE2EPipeline.coreFeedProjectionPath)")
                .font(.caption2)
                .foregroundStyle(.secondary)
                .lineLimit(2)
